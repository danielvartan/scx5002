...
breed [x-axes x-axis] ; added x-axes so that singular and plural in breed names
breed [y-axes y-axis] ; added y-axes so that singular and pluaral in breed names
...
to draw-plot
    ask patch 2 2 [
    sprout-y-axes 1 [set size 1 set heading 0 set color black pd    ] ; changed sprout-y-axis to sprout-y-axes
    sprout-x-axes 1 [set size 1 set heading 90 set color black pd   ] ; changed sprout-x-axis to sprout-x-axes
  ]
  repeat max-pxcor - 3 [
      ask x-axes [display fd 1  ] ; changed x-axix to x-axes
  ]

   repeat max-pycor - 3 [
      ask y-axes [display fd 1  ] ; changed y axis to y-axes
  ]
