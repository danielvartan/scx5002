...
This is a simple model meant to introduce Netlogo. It features a single ant moving around, with some randomness in what direction it turns and how many steps it takes at each tick. 
...
If you use this model, please cite it as: “One Ant” model, Complexity Explorer project, http://complexityexplorer.org
