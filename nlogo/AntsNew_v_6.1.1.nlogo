...
(Note:  This is a slight modification of the original Ants model from the NetLogo Models Library: this version of the model stops once all the food has been eaten.)   
